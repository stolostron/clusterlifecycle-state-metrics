...
`
	managedClusterACMResponse = `# HELP acm_managed_cluster_info Managed cluster information
# TYPE acm_managed_cluster_info gauge
acm_managed_cluster_info{hub_cluster_id="787e5a35-c911-4341-a2e7-65c415147aeb",managed_cluster_id="hive_cluster_id",vendor="OpenShift",cloud="Amazon",version="4.3.1",created_via="ACM",vcpu="3"} 1
`
)
	...
	It("Get created cluster-hive Metrics", func() {
		...
		By("Getting metrics", func() {
			Eventually(func() string {
				...
				return b
			}).Should(Equal(managedClusterACMResponse))
		})
	})
})
