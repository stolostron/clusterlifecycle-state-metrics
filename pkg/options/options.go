...
func (o *Options) AddFlags() {
	...
	o.flags.BoolVar(&o.Help, "help", false, "Print Help text")
	...
	o.flags.BoolVar(&o.Version, "version", false, "openshift-state-metrics build version information")
